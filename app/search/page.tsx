...
export const metadata: Metadata = {
  ...
  description: `Barbearia, estética e beleza em Florianópolis: compare perfis, preços e disponibilidade no ${SITE_NAME}.`,
  openGraph: {
    title: `Buscar profissionais | ${SITE_NAME}`,
    description: "Filtre por disponibilidade, preço e avaliação e agende com clareza.",
