...
export function ProfessionalPublicSettingsForm({ initialDisplayName, initialServiceRegion }: Props) {
  ...
  return (
    <form
      ...
      onSubmit={async (e: FormEvent) => {
        ...
        setBusy(true);
        try {
          const res = await updateMyProfessionalPublic({ displayName, serviceRegion });
          if (!res.ok) {
            setErr(res.message);
            return;
          }
